    ...
    <>
      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="relative z-20 h-35 md:h-65">
          <Image
            src={"/images/cover/losAngeles.jpg"}
            alt="profile cover"
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            <h3 className="mb-1.5 text-2xl font-semibold text-blue-400 dark:text-white">
              Soham Pilli
            </h3>
            ...
            <div className="mx-auto max-w-180 mt-5">
              <h4 className="font-semibold text-blue-400 dark:text-white">
                About Me
              </h4>
              <p className="mt-4.5">
              Hello! I am a high school full-stack developer with a passion for creating projects as a freelancer for my clients. I work with a diverse range of technologies, including React JS, Next JS, Swift, and many others. I am eager to bring my technical skills and enthusiasm for software development to UCLA, an institution renowned for its focus on technology and innovation.
              </p>
            </div>
