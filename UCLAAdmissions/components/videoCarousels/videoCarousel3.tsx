...
const ExtraCurriculars = ({ style }: { style?: React.CSSProperties }) => {
  const campusInfo = [
    {
        image: '/images/extraCurriculars/extraCurric1.jpg',
        title: 'Rutgers Tennis',
        link: 'https://www.youtube.com/watch?v=EXzCJ2sMs7k&pp=ygUWbGl2aW5nc3RvbiBjYW1wdXMgdG91cg%3D%3D',
    },
    {
      image: '/images/extraCurriculars/extraCurric2.jpg',
      title: 'Delta Sigma Pi Professional Fraternity',
      link: 'https://www.youtube.com/watch?v=J7GGmn7RAzY&pp=ygURYnVzY2ggY2FtcHVzIHRvdXI%3D',
    },
    {
      image: '/images/extraCurriculars/extraCurric3.jpg',
      title: 'Association of Indians at Rutgers',
      link: 'https://www.youtube.com/watch?v=Kxmg6UfGV4E&pp=ygUXY29sbGVnZSBhdmUgY2FtcHVzIHRvdXI%3D',
    },
    {
      image: '/images/extraCurriculars/extraCurric4.png',
      title: 'Rutgers Mobile App Development',
